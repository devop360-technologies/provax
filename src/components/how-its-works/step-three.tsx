  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0f24]">
      ...
      <div className="absolute inset-0">
        <Image
          src="/provax-images/How-Its-Works/four.png"
          alt="Upload Photos"
          fill
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-white/60 font-medium">Step 03</span>
            </div>
            ...
            Get your official Vehicle Integrity Score (VIS) instantly after AI inspection. A transparent, data-backed rating that reflects your vehicle’s true condition.
            </p>
