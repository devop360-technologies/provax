  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0f24]">
      ...
      <div className="absolute inset-0">
        <Image
          src="/provax-images/How-Its-Works/five.png"
          alt="Upload Photos"
          fill
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-white/60 font-medium">Step 04</span>
            </div>
            ...
            Use your AI certification to sell your vehicle faster or request trusted mechanical services. <span className="text-[#00ff7f] font-bold">PROVAX</span> connects you with verified buyers and top-rated providers instantly.
            </p>
