      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="h-8 gap-2 rounded bg-[#10B981] px-3 text-xs font-medium text-white hover:bg-[#059669]"
          >
          ...
          <Button
            ...
            className="h-8 gap-2 rounded bg-[#FF6B6B] px-3 text-xs font-medium text-white hover:bg-[#EE5A52]"
          >
            <Download className="size-3" />
            Export PDF
          </Button>
          <Button
            ...
            className="h-8 gap-2 rounded border border-[#404254] bg-transparent px-3 text-xs font-medium text-gray-400 hover:bg-[#252850]"
          >
            Expand
          </Button>
        </div>
