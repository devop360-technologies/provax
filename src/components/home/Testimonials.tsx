...
//             <p className="text-[10px] font-light tracking-widest text-cyan-300/80 uppercase md:text-sm">
//               Ratings & Reviews
//             </p>
//           </div>
...
//             <div
//               key={testimonial.id}
//               className={`relative rounded-2xl border p-5 transition-all duration-300 bg-gradient-to-br from-green-500/10 to-green-800  ${
//                 activeTestimonial === index
//                   ? "border-green-400/50 bg-gradient-to-br from-green-700/10 via-green-900/20 to-green-700/30 shadow-lg shadow-green-500/20"
//                   : "border-green-400/50 bg-gradient-to-br from-green-700/10 via-green-900/20 to-green-700/30 shadow-lg shadow-green-500/20"
//               }`}
...
//                 <Image
//                   src={
//                     "https://t4.ftcdn.net/jpg/13/66/62/19/360_F_1366621973_KNVZ3b4VTVkOojnUDVGlSYLeiWnJGSjk.jpg"
//                   }
...
//                 />
//                 <div>
//                   <h4 className="mb-1 text-sm font-semibold text-white">{testimonial.name}</h4>
//                   <p className="text-[10px] text-gray-300/80">{testimonial.position}</p>
//                 </div>
//               </div>
...
export default function Testimonials() {
  ...
  return (
    ...
    >
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-br from-[#0A0F24]/95 via-[#0A0F24]/90 to-[#0A0F24]/95"></div> */}
      ...
      <div className="relative z-10 container mx-auto max-w-7xl">
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
          {testimonials.map((testimonial, index) => (
            <div
              key={testimonial.id}
              className={`relative rounded-2xl border p-5 transition-all duration-300 bg-gradient-to-br from-green-500/10 to-green-800 backdrop-blur-sm ${
                activeTestimonial === index
                  ? "border-green-400/50 bg-gradient-to-br from-green-700/10 via-green-900/20 to-green-700/30 shadow-lg shadow-green-500/20"
                  : "border-green-400/50 bg-gradient-to-br from-green-700/10 via-green-900/20 to-green-700/30 shadow-lg shadow-green-500/20"
              }`}
