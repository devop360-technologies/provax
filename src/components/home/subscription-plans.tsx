...
export default function SubscriptionPlans() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#0a0f24] px-4 py-15 md:py-20  md:px-8">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          ...
          {/* Main Heading */}
          <h2 className="mb-5 text-2xl leading-tight text-white md:text-3xl lg:text-4xl">
            Choose Your Plan - Start Bidding Smarter
          </h2>

          {/* Description */}
          <p className="mx-auto max-w-3xl text-[12px] leading-relaxed text-white/70 md:text-base">
