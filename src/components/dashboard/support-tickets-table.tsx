...
const supportTickets: SupportTicket[] = [
  { id: "#TX-7845", subject: "Payment not processed", request: "sarah.johnson@example.com", topic: "Billing", priority: "High", status: "Open", agent: { name: "Sarah Johnson", avatar: "👩‍💼" }, created: "2023-10-15" },
  { id: "#TX-7844", subject: "Cannot upload certification document", request: "michael.brown@example.com", topic: "Technical Issue", priority: "Medium", status: "Pending", agent: { name: "Michael Brown", avatar: "👨‍💼" }, created: "2023-10-14" },
  { id: "#TX-7843", subject: "Account verification problem", request: "emily.davis@example.com", topic: "Account Problem", priority: "Medium", status: "Open", agent: null, created: "2023-10-14" },
  { id: "#TX-7842", subject: "Feature request: bulk upload", request: "john.smith@example.com", topic: "Feature Request", priority: "Low", status: "Resolved", agent: { name: "John Smith", avatar: "🧑‍💼" }, created: "2023-10-13" },
];
